---
title: "metaphlan heatmap - human breast milk"
...
```{r}
mpa_file.milk <- read_delim("data/species_composition/milk_samples_merged_abundance.txt", delim = '\t')
mpa_file.stool <- read_delim("data/species_composition/infant_samples_merged_abundance.txt", delim = '\t')
...
metadata.master.ext <- metadata.master %>% 
  mutate(Sample_ID_ext = paste0(Sample_ID, "_mean"))

colnames_ordered.milk.metadata <- left_join(colnames_ordered.milk, metadata.master.ext, by=c("rowname"="Sample_ID_ext")) 
...
colnames_ordered.stool.metadata <- left_join(colnames_ordered.stool, metadata.master.ext, by=c("rowname"="Sample_ID_ext")) 
