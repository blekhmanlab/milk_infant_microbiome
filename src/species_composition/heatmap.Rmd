...
```{r}
#stool 
mpa_file.stool <- read_delim("data/species_composition/infant_rel_abundance.txt", delim = '\t')
#milk
mpa_file.milk <- read_delim("data/species_composition/milk_rel_abundance.txt", delim = '\t')
...
metadata.stool.full <- left_join(colnames_ordered.stool.metadata, bifido_groups, by=c("Sample_ID"="Sample"))
...
#add info bifido groups
metadata.milk.full <- left_join(colnames_ordered.metadata, bifido_groups, by=c("Sample_ID"="Sample"))
