...
metadata.full <- left_join(metadata, bifido_groups, by=c("Sample_ID"="Sample"))

#merge with metadata table
merged.species <- left_join(mpa_file.species.long, metadata.full, by=c("Sample"="Sample_ID"))
